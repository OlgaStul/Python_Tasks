...
word = (input("Введите слово, используя либо английский, либо русский алфавит: word = ")).lower()
number = int(input("Введите 1, если используем английский алфавит, и 0, если используем русский алфавит: "))
dictionary_eng = {1:'a,e,i,o,u,l,n,s,t,r', 2:'d,g', 3:'b,c,m,p', 4:'f,h,v,w,y', 5:'k', 8:'j,x', 10:'q,z'}
dictionary_rus = {1:'а,в,е,и,н,о,р,с,т', 2:'д,к,л,м,п,у', 3:'б,г,ё,ь,я', 4:'й,ы', 5:'ж,з,х,ц,ч', 8:'ш,э,ю',
                 10:'ф,щ,ъ'}
sum = 0
i = 0
if number == 1:
    ...
    for i in word:
        for k, v in dictionary_rus.items():
            if i in v:
                sum += k
print(f'Слово {word} оценивается в {sum} очков')
