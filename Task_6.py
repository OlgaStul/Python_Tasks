...
if number >= 000000 and number < 1000000:
    if number//100000 + number//10000 % 10 + number//1000 % 10 == number//100 % 10 + number//10 % 10 + number % 10:
        print(f"{number//100000 + number//10000 % 10 + number//1000 % 10} = {number//100 % 10+number//10 % 10 + number % 10} -> Билет счастливый!")
    else:
        print(f"{number//100000 + number//10000 % 10 + number//1000 % 10} = {number//100 % 10 + number//10 % 10 + number % 10} -> Билет не счастливый!")
else:
    print("Ввели не шестизначный номер. Повторите ввод!")
